...
#function for product discription generator


# def desc_generator(text):
#     product_desc = []

#     response = openai.Completion.create(
#   model="text-davinci-003",
#   prompt="Write a comprehensive product description and define the product functionalities, uses and benefits for:{} \n".format(text),
#   temperature=0.7,
#   max_tokens=658,
#   top_p=1,
#   frequency_penalty=0,
