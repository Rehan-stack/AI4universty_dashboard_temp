...
def show_ads(request):
    if 'generate_ads' in request.session:
        pass
    else:
        messages.error(request,"start by making product names")
...
#         text_easy= easy_text(text)
#         if len(text_easy) > 0:
#             request.session['product_desc'] = text_easy
#             return redirect('show_product_desc')
#         else:
#             messages.error(request,"oops we coounld not generate keywords for you")
#             return redirect('show_product_desc')

#     return render(request,'dashboard/product_desc.html',context)



# @login_required
# def show_product_desc(request):
#     if 'product_desc' in request.session:
#         pass
#     else:
#         messages.error(request,"start by providing the text")
...
#     context = {}
#     context['product_desc'] = request.session['product_desc']

#     return render(request,'dashboard/show_product_desc.html',context)
